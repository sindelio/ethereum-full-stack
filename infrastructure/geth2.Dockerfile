...
COPY ./geth2/nodekey /etherdata/dd/geth/nodekey
...
COPY ./geth2/account/privatekey /etherdata/account/privatekey
# 
COPY ./geth2/account/password /etherdata/account/password
